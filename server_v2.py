...
class Tracker:
    ...
    def _prepare_response_params(self, info_hash, error_flag):
    ...
    async def announce(self, request):
        ...
        return web.Response(body=self._prepare_response_params(info_hash, error_flag), content_type='text/plain')
